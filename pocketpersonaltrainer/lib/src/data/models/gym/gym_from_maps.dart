class GymFromMaps {
  ...
  GymFromMaps({this.htmlAttributions, this.nextPageToken, this.results, this.status});

  GymFromMaps.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.htmlAttributions != null) {
      data['html_attributions'] = this.htmlAttributions!.map((v) => v.toJson()).toList();
    }
