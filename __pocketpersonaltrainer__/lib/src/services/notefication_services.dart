...
class NotificationServices {
  ...
  Future<void> createLocalInstantNotification() async {
    await awesomeNotifications.createNotification(
      content: NotificationContent(
          ...
          icon: "asstes/images/New_Logo.png",
  ...
  Future<void> createScheduleNotification(DateTime datePicked, {bool? isWeekendOn}) async {
    try {
      await awesomeNotifications.createNotification(
  ...
  static Future<void> onActionReceivedImplementationMethod(ReceivedAction receivedAction) async {
    ...
    if (receivedAction.buttonKeyInput == "fazerAgora") {
      ...
      MyApp.navigatorKey.currentState?.push(MaterialPageRoute(builder: (context) => HomePage()));
    }
  }
